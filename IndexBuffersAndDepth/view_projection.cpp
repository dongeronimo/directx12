...
dx3d::ViewProjection::ViewProjection( Context& ctx)
{
...
void dx3d::ViewProjection::SetPerspective(float fovInDegrees, float aspectRatio, float nearZ, float farZ)
{
...
void dx3d::ViewProjection::LookAt(DirectX::FXMVECTOR EyePosition, DirectX::FXMVECTOR FocusPosition, DirectX::FXMVECTOR UpDirection)
{
...
void dx3d::ViewProjection::StoreInBuffer()
{
